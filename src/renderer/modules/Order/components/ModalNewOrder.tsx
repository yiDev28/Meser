          ...
          {step === 3 && (
            <div className="flex flex-col h-full overflow-hidden">
              <div className="grid grid-cols-12  gap-4 h-full">
                <div className="col-span-2 col-start-1 h-full overflow-y-auto overflow-x-hidden p-2 border border-neutral-gray/50 rounded-lg custom-scrollbar">
                ...
                <div className="col-span-5 h-full overflow-y-auto overflow-x-hidden custom-scrollbar">
                ...
                <div className="mt-2 flex col-span-12 justify-between ">
                  ...
                  <ButtonActionsPadding
                    ...
                    iconPosition="right"
                    mode="primary"
                    disabled={payload.items.length === 0}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full overflow-hidden">
              <div className="h-full overflow-y-auto overflow-x-hidden custom-scrollbar">
                ...
                <div className="mt-2">
                  <TexTareaGeneric
                    name="notes"
                    label="Notas generales de la orden"
                    placeholder="Ej: cubiertos, servilletas..."
                    value={payload.notes}
                    onChange={handleChange}
                    size="lg"
                  />
