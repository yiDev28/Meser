...
const CardCatProd: React.FC<CardCatProdProps> = ({
  ...
  return (
    <div
      ...
      } rounded-lg cursor-pointer text-neutral-dark py-4 border border-neutral-gray/50 
        hover:shadow-lg hover:bg-neutral-gray/70 hover:text-neutral-light animate-scaleIn`}
      onClick={onClick}
    >
      <div className="flex flex-col items-center justify-center">
        <img
          src={category.imagePath || category.urlImage}
