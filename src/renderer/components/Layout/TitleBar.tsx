...
export default function TitleBar({ onSettingsClick }: TitleBarProps) {
  ...
  const { minimizeWindow, maximizeWindow, closeWindow, isMaximized } = useApp();
  ...
  const titleBarTitle = getConfig("title_bar_title") || "Meser - Todo bajo control";
  ...
  return (
    <div 
      className="flex justify-between items-center h-8 select-none bg-secondary"
