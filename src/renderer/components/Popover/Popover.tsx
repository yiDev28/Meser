      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            className="relative bg-neutral-dark rounded-lg shadow-lg  p-5 w-64 z-9999"
          >
            {/* Contenido */}
            {children}
            ...
            {/* Flecha */}
            {placement === "right" && (
              <div className="absolute top-10 -left-2 -translate-y-1/2 w-0 h-0 border-y-8 border-y-transparent border-r-8 border-r-neutral-dark" />
            )}
            {placement === "left" && (
              <div className="absolute top-6 -right-2 -translate-y-1/2 w-0 h-0 border-y-8 border-y-transparent border-l-8 border-l-neutral-dark" />
            )}
            {placement === "top" && (
