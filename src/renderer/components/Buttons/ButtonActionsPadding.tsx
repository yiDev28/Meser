...
export function ButtonActionsPadding({
  type = "button",
  mode = "info",
  size = "md",
  label,
  ...
  return (
    <button
      className={`cursor-pointer rounded-md flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed
        ${typeClasses[mode]} ${sizeClasses[size].button}
